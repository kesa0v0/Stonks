...
@router.get("/seasons", response_model=List[SeasonResponse], dependencies=[Depends(get_rate_limiter("/rankings/seasons"))])
...
@router.get("/hall-of-fame", response_model=HallOfFameResponse, dependencies=[Depends(get_rate_limiter("/rankings/hall-of-fame"))])
...
@router.get("/{ranking_type}", response_model=List[RankingEntry], dependencies=[Depends(get_rate_limiter("/rankings/{ranking_type}"))])
